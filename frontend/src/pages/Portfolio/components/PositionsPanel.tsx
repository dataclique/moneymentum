      ...
      <td class="px-2 py-1 font-medium">
        ...
        <Dialog>
          <DialogTrigger
            ...
            variant="ghost"
            size="sm"
            class="ml-1 h-auto px-1.5 py-0 text-[10px] font-mono border border-border rounded"
...
export const PositionsPanel = (props: PositionsPanelProps): JSX.Element => {
  return (
    <div class="flex flex-col rounded border border-border min-h-0 max-h-[calc(100vh-4rem)] w-full max-w-[540px] shrink-0">
            ...
            <table class="w-full">
              <thead class="sticky top-0 bg-muted/90 z-10">
                <tr class="text-muted-foreground text-[10px]">
                  ...
                  <th class="px-2 py-1 text-right font-medium">Γ</th>
                  <th class="px-2 py-1 text-right font-medium">Θ</th>
