...
def compare_csv_content(file1_path: str, file2_path: str) -> tuple[bool, str]:
    """
    ...
    try:
        ...
        if not df1.columns.equals(df2.columns):
            ...
            diff_str = "Column names or order differ."
        else:
            # 2. Sort data
...
if __name__ == "__main__":
    ...
    are_identical, _ = compare_csv_content(
        "analysis_df_1h.csv", "analysis_df_1h_optimized.csv"
    )  # Expected False
