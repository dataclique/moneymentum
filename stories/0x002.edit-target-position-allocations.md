...
As a user, I want to edit target position allocations by weight, notional, side,
and per-position leverage so that the portfolio expresses my intended exposure
before I rebalance.
