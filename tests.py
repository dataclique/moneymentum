...
def test_aave_last_record(spark_session):
    ...
    # Google sheet: 97.76%
    assert aave_last_record["annualized_volatility"] == 0.9775370372243625, "Annualized volatility mismatch"
    # Google sheet: 0.29
...
def test_btc_last_record(spark_session):
    ...
    # Google sheet: 52.42%
    assert btc_last_record["annualized_volatility"] == 0.5242014994136859, "Annualized volatility mismatch"
    # Google sheet: 1.00
...
def test_ai_last_record(spark_session):
    ...
    # Google sheet: 116.28%
    assert ai_last_record["annualized_volatility"] == 1.1627588432389253, "Annualized volatility mismatch"
    # Google sheet: 0.28
